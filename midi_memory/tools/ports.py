"""List the MIDI input ports this machine can see: `python -m midi_memory.tools.ports`."""
...
def main() -> int:
    ...
    if platform.system() == "Linux":
        backends.append(("ALSA sequencer", "midi_memory.client.midi.alsa_source"))
    backends.append(("rtmidi2", "midi_memory.client.midi.portable_source"))
