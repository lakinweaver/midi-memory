...
from app.midi.recorder import MIDI_FILENAME
from app.midi.smf import extract_notes, read_smf
...
async def search_sessions(
    ...
    return request.app.state.db.search(
        ...
        favorite_only=favorite, sort=sort, order=order, limit=limit, offset=offset,
    )
